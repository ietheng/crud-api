...
import busfront from "../assets/busfront.jpg";

export default function AuthPage() {
  //   const loginImage = "https://sig1.co/img-twitter-1";
  <img className="h-10" src={busfront} alt="" />;
  ...
  return (
    <Row>
      <Col sm={6}>
        <Image src={busfront} fluid style={{ height: "722px" }} />
      </Col>
      <Col sm={6} className="p-4">
        <i
          className="bi bi-bus-front"
          style={{ fontSize: 50, color: "#E48F45" }}
        ></i>
        <p className="mt-3" style={{ fontSize: 64 }}>
          Grab your ticket now!
        </p>
        <h2 className="my-4" style={{ fontSize: 31 }}>
          ...
          <Modal.Body>
            ...
            >
              ...
              <p style={{ fontSize: "12px" }}>
                ...
                Policy, including Cookie Use. SigmaTweets may use you contact
